  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "UNDERSTANDING", highlight: true },
        { text: " OVER MEMORIZATION", highlight: false },
      ],
      description: "We teach concepts, not just facts. Deep learning that sticks.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: " AT EVERY STEP", highlight: false },
      ],
      description: "Every explanation is simple, direct, and builds on what you know.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "PERSONALIZED ", highlight: false },
        { text: "LEARNING", highlight: true },
      ],
      description: "Your AI tutor adapts to your pace, style, and learning preferences.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "CONFIDENCE ", highlight: false },
        { text: "THROUGH MASTERY", highlight: true },
      ],
      description: "From confusion to clarity. Every lesson builds real confidence.",
      align: "right",
    },
  ]
