...
const signals = [
  {
    ...
    note: "AI adjusts difficulty and pacing to match your learning speed and style.",
  },
  {
    date: "2025.05.28",
    title: "Deep Explanations",
    note: "Every concept broken down step-by-step with visual examples and analogies.",
  },
  {
    date: "2025.05.15",
    title: "Interactive Quizzes",
    note: "Test understanding with real-time feedback and targeted guidance.",
  },
  {
    date: "2025.04.30",
    title: "Study Plans",
    note: "Personalized learning roadmaps tailored to your goals and timeline.",
  },
  {
    date: "2025.04.12",
    title: "Flashcard Generation",
    note: "Automatically create review cards from any topic you study.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">YOUR LEARNING EDGE</h2>
      </div>
